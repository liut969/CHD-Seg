...
from utils.loss import dice_loss, soft_dice_loss, shape_match_loss
    ...
    for epoch in range(20, epochs):
        ...
        with tqdm(total=n_train, desc='Epoch {0}/{1}'.format(epoch + 1, epochs), unit='img') as pbar:
            for i, b in enumerate(batch(train, batch_size)):
                ...
                true_masks_np = np.copy(true_masks)
                ...
                loss = shape_match_loss(true_masks.long(), masks_pred, true_masks_np)
